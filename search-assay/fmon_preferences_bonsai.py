...
experimenter = 'Kaitlyn Yamada' #your full name
...
initial_weight = '22.31' #in grams
group_name = "100-0" #what experiment are you running? (OPTIONS: trainer1, trainer2, 100-0, 80-20, 60-40, interleaved, abs-conc, non-spatial, nostril-occlusion, doi) 
...
wcL = '6.77'#left water port calibration (how many microliters per reward?)
wcR = '6.72' #right water port calibration
wcIP = 'NA' #initiation water port calibration
odortype = '2pe' #odor identity (pinene, octanol, amyl acetate, methyl salicate, etc.)
...
#Odor vials! Key: 6 = blank, 7 = Benzaldehyde (.1%), 8 = 2-PE (0.01%)
odor_vial = 8 #main odor (7 = Benzaldehyde), 8 = 2PE^^^^
