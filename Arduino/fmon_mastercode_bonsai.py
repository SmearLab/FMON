...
def msg_handler(addr, tags, coords, source):
    ...
    ts[0,0] = time.time()-session_start; 
...
#   [State *](occurs in all states)
    ...
    if show_active_stats == True: #online trial statistics
        ...
        fraction_correct = "Total:    "+str(correct0)+"/"+str(total0)+".    "+str(correct1)+"/"+str(total1)+".    "+str(correct2)+"/"+str(total2)+".    "+str(correct3)+"/"+str(total3)+". "  #session stats
        fraction_left = "Left:   "+str(correct0L)+"/"+str(total0L)+".     "+str(correct1L)+"/"+str(total1L)+".     "+str(correct2L)+"/"+str(total2L)+".     "+str(correct3L)+"/"+str(total3L)+". "
        fraction_right = "Right:   "+str(correct0R)+"/"+str(total0R)+".     "+str(correct1R)+"/"+str(total1R)+".     "+str(correct2R)+"/"+str(total2R)+".     "+str(correct3R)+"/"+str(total3R)+". "
        #Stats Display
        ...
        if group_name == 'non-spatial':
            cv2.putText(frame,'xxxx    M.S.   Octanol  CONTROL', (130,(height/2)-40), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,0))
        else: cv2.putText(frame,'100-0    80-20    60-40    CONTROL', (130,(height/2)-40), cv2.FONT_HERSHEY_PLAIN, 1, (0,0,0))
...
else: print '   100-0 80-20 60-40 CONTROL'
