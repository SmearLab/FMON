...
experimenter = 'Reese Findley' #your full name
mouse_id = "2065" #mouse subject number
group_name = "nostril-occlusion" #what experiment are you running? (OPTIONS: trainer1, trainer2, 100-0, 80-20, 60-40, interleaved, abs-conc, non-spatial) 
...
occluded_nostril = 'none' #is a nostril occluded? (none, left, right)
wcL = '8.13'#left water port calibration (how many microliters per reward?)
wcR = '8.08' #right water port calibration
wcIP = '8.38' #initiation water port calibration
odortype = 'none' #odor identity (pinene, octanol, amyl acetate, etc.)
...
#Data Paths
base_dir = "C:/Users/Smear Lab/Dropbox/" #root of data path (below, data compilation file location)
compdatafile = "C:/Users/Smear Lab/workspace/FMON/DataCompilation/data_compilation_"+group_name+".txt"
#Timing
