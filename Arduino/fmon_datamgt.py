...
Last Updated: 01.04.2018, Teresa Findley
'''
...
def CHK_directory(mouse_id,group_name,session_num):
    while True:
        datapath = base_dir + "data/Mouse_" + mouse_id + "/" + group_name + "/" + str(session_num) + "/"
...
def randomize_trials(random_groupsize,total_groupsize):
    ...
    for i in range (1,(total_groupsize/random_groupsize)):
        ...
        if group_name == '80-20' or group_name == 'non-spatial':
