...
abs_conc_odor_calibration = np.genfromtxt(base_dir + 'data/abs-conc_olfactometercalibration.txt', delimiter = ',') #odor calibration array
...
#   [State 1] TRIAL INITIATION   
    if state == 1: 
        if prep_odor == True: 
            ...
            active_valve = 1
            HairR,LairR,HairL,LairL,Hn2R,Ln2R,Hn2L,Ln2L,activevial,lowvial = fmon_serial.MFC_settings(concentration_setting,odor_calibration,abs_conc_odor_calibration,active_valve)
            if port_val == 1:
